package com.noto.app.data.settings
...
import com.noto.app.data.settings.model.LocalNotoData
import com.noto.app.data.settings.model.LocalSettingsConfig
...
class SettingsRepositoryImpl(
    ...
    override val mainInterfaceId: Flow<Long> = localSettingsDataSource.getOrDefault(SettingsKeys.MainInterfaceId, FilteredItem.AllFoldersId)
    ...
    override fun getFilteredNotesScrollingPosition(model: FilteredItem): Flow<Int> =
    ...
    override suspend fun updateFilteredNotesScrollingPosition(model: FilteredItem, scrollingPosition: Int) =
