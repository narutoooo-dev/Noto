...
import com.noto.app.domain.asSearchFlow
...
import com.noto.app.ui.folder.noteItem
import com.noto.app.ui.getOrDefault
import com.noto.app.ui.util.*
import com.noto.app.widget.updateAllWidgetsData
...
class FilteredFragment : Fragment() {
    ...
    private fun FilteredFragmentBinding.setupState() {
        if (args.model == FilteredItem.Archived) {
        ...
        context?.let { context ->
            ...
            tvTitle.text = when (args.model) {
                FilteredItem.All -> R.string.all
                FilteredItem.Recent -> R.string.recent
                FilteredItem.Scheduled -> R.string.scheduled
                FilteredItem.Archived -> R.string.archived
...
//        rv.edgeEffectFactory = BounceEdgeEffectFactory()
        ...
        combine(
            ...
            if (args.model != FilteredItem.Archived) fab.isVisible = !isKeyboardVisible
                    ...
                    context?.let { context ->
                        if (notes.values.all { it.isEmpty() }) {
                            val placeholderId = when {
                                ...
                                args.model == FilteredItem.Recent -> R.string.no_recent_notes_found
                                args.model == FilteredItem.Scheduled -> R.string.no_scheduled_notes_found
    ...
    private fun FilteredFragmentBinding.setupNotesGroupedByFolder(
        ...
        val isArchivedModel = args.model == FilteredItem.Archived
                ...
                rv.withModels {
                    ...
                    context?.let { context ->
                        if (notes.values.all { it.isEmpty() }) {
                            val placeholderId = when {
                                searchTerm.isNotBlank() -> R.string.no_notes_found_search
                                args.model == FilteredItem.Archived -> R.string.no_archived_notes_found
                                args.model == FilteredItem.All -> R.string.no_relevant_notes_found
                                else -> R.string.no_notes_found
                            }
