    ...
    override fun onCreateView(
        ...
        ComposeView(context).apply {
            ...
            setContent {
                ...
                val filteredItemId = remember(mainInterfaceId) {
                    FilteredItem.entries.firstOrNull { it.id == mainInterfaceId }?.toStringResourceId() ?: R.string.default_main_interface
                }
                val filteredItemModelText = stringResource(id = filteredItemId)
                val mainInterfaceText by produceState(initialValue = filteredItemModelText, mainInterfaceId) {
                    value = when (mainInterfaceId) {
                        in FilteredItem.Ids.plus(FilteredItem.AllFoldersId) -> filteredItemModelText
