package com.noto.app.ui.component.activity
...
import com.noto.app.domain.isValid
import com.noto.app.ui.note.QuickNoteDialogFragment
import com.noto.app.ui.util.Constants
import com.noto.app.ui.util.IntentConstants
import com.noto.app.ui.util.sendQuickNoteNotification
...
class TransparentActivity : BaseActivity() {
    ...
    private fun handleIntentContent() {
        when (intent?.action) {
            ...
            IntentConstants.ActionQuickNote -> { // Notification Center then Quick Note.
