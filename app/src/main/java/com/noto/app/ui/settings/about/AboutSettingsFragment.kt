package com.noto.app.ui.settings.about
...
import com.noto.app.domain.NotoConstants
import com.noto.app.ui.component.screen.Screen
import com.noto.app.ui.settings.*
                ...
                Screen(
                    ...
                    SettingsSection {
                        SettingsItem(
                            ...
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(NotoConstants.DeveloperUrl))
                        ...
                        SettingsItem(
                            ...
                            onClick = {
                                val intent = Intent(Intent.ACTION_SENDTO, Uri.parse(Constants.EmailType)).apply {
                                    putExtra(Intent.EXTRA_EMAIL, arrayOf(NotoConstants.Email))
                                    putExtra(Intent.EXTRA_SUBJECT, NotoConstants.TranslationEmailSubject)
                                    putExtra(Intent.EXTRA_TEXT, NotoConstants.TranslationEmailBody)
                                }
                                startActivity(intent)
                            },
                    ...
                    SettingsSection {
                        SettingsItem(
                            ...
                            type = SettingsItemType.None,
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(NotoConstants.GithubUrl))
                                startActivity(intent)
                            },
                        ...
                        SettingsItem(
                            ...
                            type = SettingsItemType.None,
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(NotoConstants.TelegramUrl))
                                startActivity(intent)
                            },
                    ...
                    SettingsSection {
                        SettingsItem(
                            ...
                            type = SettingsItemType.None,
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(NotoConstants.PrivacyPolicyUrl))
                                startActivity(intent)
                            },
                        ...
                        SettingsItem(
                            ...
                            onClick = {
                                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(NotoConstants.LicenseUrl))
                                startActivity(intent)
                            },
