...
import com.noto.app.ui.component.activity.TransparentActivity
...
class QuickNoteTileService : TileService() {
    ...
    override fun onClick() {
        val intent = Intent(IntentConstants.ActionQuickNote, null, this, TransparentActivity::class.java).apply {
