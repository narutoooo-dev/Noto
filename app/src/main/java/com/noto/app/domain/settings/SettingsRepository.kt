package com.noto.app.domain.settings
...
interface SettingsRepository {
    ...
    fun getFilteredNotesScrollingPosition(model: FilteredItem): Flow<Int>
    ...
    suspend fun updateFilteredNotesScrollingPosition(model: FilteredItem, scrollingPosition: Int)
