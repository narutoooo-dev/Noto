                                ...
                                item {
                                    Column(
                                        ...
                                        Row(
                                            ...
                                            FilteredItem(
                                                item = FilteredItemModel.All,
                                                notesCount = notesCount.all,
                                                isSelected = FilteredItemModel.All.id == args.selectedFolderId,
                                                isShowNotesCount = isShowNotesCount,
                                                onClick = { returnResult(FilteredItemModel.All.id, context.stringResource(R.string.all)) },
                                                modifier = Modifier.weight(1F),
                                            )

                                            FilteredItem(
                                                item = FilteredItemModel.Recent,
                                                notesCount = notesCount.recent,
                                                isSelected = FilteredItemModel.Recent.id == args.selectedFolderId,
                                                isShowNotesCount = isShowNotesCount,
                                                onClick = { returnResult(FilteredItemModel.Recent.id, context.stringResource(R.string.recent)) },
                                                modifier = Modifier.weight(1F),
                                            )
                                        }
                                        ...
                                        Row(
                                            ...
                                            FilteredItem(
                                                item = FilteredItemModel.Archived,
                                                notesCount = notesCount.archived,
                                                isSelected = FilteredItemModel.Archived.id == args.selectedFolderId,
                                                isShowNotesCount = isShowNotesCount,
                                                onClick = { returnResult(FilteredItemModel.Archived.id, context.stringResource(R.string.archived)) },
                                                modifier = Modifier.weight(1F),
                                            )
                                        }
                                    }
