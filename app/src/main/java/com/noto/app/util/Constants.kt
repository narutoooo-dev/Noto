...
object Constants {
    ...
    object Noto {
        const val Email = "flashteam273@gmail.com"
        const val DeveloperUrl = "https://t.me/d_b_if"
        const val LicenseUrl = "https://www.apache.org/licenses/LICENSE-2.0"
        const val PlayStoreUrl = "https://play.google.com/store/apps/details?id=com.noto.debug"
        const val GithubUrl = "https://github.com/narutoooo-dev/Noto"
        const val TelegramUrl = "https://t.me/noto_forum"
        ...
        const val GitHubReleasesUrl = "https://github.com/narutoooo-dev/Noto/releases"
        fun GitHubReleaseUrl(version: String) = "https://github.com/narutoooo-dev/Noto/releases/tag/v$version"
